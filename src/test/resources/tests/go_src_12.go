	/* The code snippet is obtained from  'https://github.com/antlr/grammars-v4/blob/master/golang/examples' *///
...
func (*person) outside() { fmt.Println("Declared outside and invoked!!!")}
